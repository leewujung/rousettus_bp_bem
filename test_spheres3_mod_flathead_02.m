...
nn = find(az>-104/180*pi & az<-100/180*pi);  % for flathead
nn = find(az>-108/180*pi & az<-100/180*pi);  % for bullethead
nn = find(az>-84/180*pi & az<-76/180*pi);  % for both flathead and bullethead

nn = find(az<92/180*pi & az>88/180*pi);
nn = find(az<106/180*pi & az>98/180*pi);  % for flathead
nn = find(az<110/180*pi & az>98/180*pi);  % for bullethead
nn = find(az<80/180*pi & az>76/180*pi);  % for flathead
nn = find(az<84/180*pi & az>76/180*pi);  % for bullethead
