...
indiv_src_path = 'calc_indiv_src_pfield_20160801b_Ra_224_14k';
...
% Load gap locations
mtx_path = 'calc_bem_20160801b_Ra_224_14k';
param_file = sprintf('%s_freq%02dkHz_param.mat',mtx_path,35);
M = load(fullfile(base_path,mtx_path,param_file));

% nn_all = [2019,972,676,3229,2950,1626];  % right
nn_all = [185,1959,1299,1560,3201,1625];  % left
...
tongue_loc_all = [0.008,0.003,-0.006];
