...
tongue_loc = [0.023,0.000,-0.008];

t_name = sprintf('%02dkHz_x%05.1f_y%05.1f_z%05.1f',...
    freq/1e3,tongue_loc(1,1)*1e3,...
    tongue_loc(1,2)*1e3,...
    tongue_loc(1,3)*1e3);
title_text = sprintf('%dkHz, tongue (%5.1f,%5.1f,%5.1f)',...
    freq/1e3,tongue_loc(1,1)*1e3,...
    tongue_loc(1,2)*1e3,...
    tongue_loc(1,3)*1e3);
...
suptitle(title_text);
save_fname = sprintf('%s_%s_all',script_name,t_name);
