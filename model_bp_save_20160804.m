...
for iT=1:num_tongue
    ...
    save_fname = sprintf('%s_%02dkHz_x%03d_y%03d_z%03d',...
        script_name,freq/1e3,...
        tongue_loc(1)*1e3,tongue_loc(2)*1e3,tongue_loc(3)*1e3);
    fig_title = sprintf('%02dkHz, tongue at (%d,%d,%d) mm',...
        freq/1e3,tongue_loc(1)*1e3,tongue_loc(2)*1e3,tongue_loc(3)*1e3);
