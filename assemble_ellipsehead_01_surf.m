...
% data_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_processing\20160319_bem3D_ellipsehead0.1_surf'];
data_path = 'F:\Dropbox\0_ANALYSIS\bp_processing\20160319_bem3D_ellipsehead0.1_surf';
...
nn_all  = [2591, 2703, 2459, 2977, 2487, 3057, 2605, 3304, 2554, 3051];  % left side
...
for iF=1:length(freq_all)
    % get shape and param
    load(fullfile(data_path,[data_fpre,'_freq',num2str(freq_all(iF)/1e3),'kHz_bem_fp_mtx.mat']),'param','shape');
