...
% data_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_processing\20160315_bem3D_flathead0.1_surf'];
data_path = 'F:\Dropbox\0_ANALYSIS\bp_processing\20160315_bem3D_flathead0.1_surf';
data_fpre = 'flathead';
...
% gap index
% nn_all  = [389, 308, 310, 395, 825];  % right middle row
