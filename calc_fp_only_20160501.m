...
if strcmp(usrn,'Wu-Jung')
    ...
    mtx_path = 'F:\Dropbox\0_ANALYSIS\bp_bem_modeling\calc_bem_20160501_bullethead';
else
    base_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_bem_modeling'];
    mtx_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_bem_modeling\calc_bem_20160501_bullethead'];
end

freq_all = [20:5:60]*1e3;
[~,script_name,~] = fileparts(mtx_path);
% ss = strsplit(script_name,'_');
% script_name = 
