...
% 2016 07 28  Assemble field for piston
...
cvec = 0:-3:-30;
az_plot_range = 90;
map_proj = 'ortho';   % use eckert4 because orthographic has very limited azimuth span
...
indiv_src_path = 'calc_indiv_src_pfield_20160727_piston';
...
% Load gap locations
mtx_path = 'calc_bem_20160727_piston';
...
load(fullfile(base_path,'pick_src_loc_20160727','nn_all_0.005.mat'));
