...
save_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_processing\20160314_bem3D_flathead0.1'];
% save_path = 'F:\Dropbox\0_ANALYSIS\bp_processing\20160314_bem3D_flathead0.1';
save_fpre = 'flathead';
...
[nodes,elements,elementsQUAD]=readgeomGMSH(['flathead_0.1.msh']); % Load mesh from GMSH file
...
%     [theta,phi] = meshgrid(-180:5:180,80:10:100);
    ...
    % Velocity
    nn_all  = [389, 308, 310, 395, 825, 3138, 3141, 3576, 3224, 3148];
    ...
    for iN=1:length(nn_all)
        ...
        bem_results.theta = theta;
        bem_results.phi = phi;
        bem_results.x = x;
        bem_results.y = y;
        bem_results.z = z;
        bem_results.xyzFP = xyzFP;
        ...
        save(fullfile(save_path,save_fname),'bem_results','shape');
