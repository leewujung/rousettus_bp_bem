...
indiv_src_path = 'calc_indiv_src_pfield_20160729b_Ra_224';
...
% Load gap locations
mtx_path = 'calc_bem_20160729b_Ra_224';
param_file = sprintf('%s_freq%02dkHz_param.mat',mtx_path,35);
M = load(fullfile(base_path,mtx_path,param_file));

% nn_all = [31815,28773,30988,30051,29437,27493];  % right
nn_all = [31842,30870,30194,33082,28527,27274];  % left
...
tongue_loc_all = [-0.005,0.004,0.000];
