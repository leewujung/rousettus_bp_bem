...
save_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_processing\20160309_near_far_field'];
save_fpre = 'head_src';
...
bem = load(fullfile(bem_path,'head_src_35kHz_bem_mtx.mat'));

nn_all = [2   96    91    86    81    76    71];
...
for iR = 1:length(Rfp_all)
    ...
    % Define field points
    [theta,phi] = meshgrid(-180:10:180,90);
