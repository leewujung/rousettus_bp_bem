...
% save_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_processing\20160312_bem3D_piston'];
save_path = 'F:\Dropbox\0_ANALYSIS\bp_processing\20160312_bem3D_piston_long';
save_fpre = 'piston';
...
for iF = 1:length(freq_all)
    ...
    [nodesb,topologyb,segments]=meshcheck(nodes,elements);  % WJL: nodesb is the actual node points used
