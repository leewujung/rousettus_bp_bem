...
% 2017 09 21  version 20161009 uses a different numbering of sources
%             that could cause confusion: used SRC.idx_left([4,5,6,2]))
%             without the type of sorting used in fig_model_steer_h_bpctr.m
%             now correct it to use the same type of sorting for source
%             locations so that the code is more trackable
...
for iT=1:num_tongue
    ...
    save_fname = sprintf('%s_%s_%02dkHz_x%03d_y%03d_z%03d_src%s',...
